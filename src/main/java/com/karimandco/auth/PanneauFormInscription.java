...
public class PanneauFormInscription extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panneauNom.setBackground(new java.awt.Color(0, 102, 153));
        panneauNom.setForeground(new java.awt.Color(255, 255, 255));

        panneauPrenom.setBackground(new java.awt.Color(0, 102, 153));
        panneauPrenom.setForeground(new java.awt.Color(255, 255, 255));

        panneauIdentifiant.setBackground(new java.awt.Color(0, 102, 153));
        panneauIdentifiant.setForeground(new java.awt.Color(255, 255, 255));

        panneauCourriel.setBackground(new java.awt.Color(0, 102, 153));
        panneauCourriel.setForeground(new java.awt.Color(255, 255, 255));

        panneauNumeroTelephone.setBackground(new java.awt.Color(0, 102, 153));
        panneauNumeroTelephone.setForeground(new java.awt.Color(255, 255, 255));

        panneauDateNaissance.setBackground(new java.awt.Color(0, 102, 153));
        panneauDateNaissance.setForeground(new java.awt.Color(255, 255, 255));
        ...
        panneauMdp.setForeground(new java.awt.Color(255, 255, 255));

        panneauMdpConfirmation.setBackground(new java.awt.Color(0, 102, 153));
        panneauMdpConfirmation.setForeground(new java.awt.Color(255, 255, 255));
